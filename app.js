...
const gallerryBox = document.querySelector(".js-gallery");
//console.log(gallerryBox);

gallerryBox.insertAdjacentHTML("afterbegin", createGalleryCard(galleryItems));

gallerryBox.addEventListener("click", onLightboxClick);
...
function onLightboxClick(event) {
  const linkElement = event.target.classList.contains("gallery__image");
  if (!linkElement) {
    return;
  }
